    ...
    <form method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="anh" id="exampleInputPassword1" required placeholder="ảnh đại diện sản phẩm">
            </div>
            Ảnh hiện tại<img style="width: 100px;height:80px;" src="../../../public/images/<?=$anh?>" alt="">
        </div>
        <!-- /.card-body -->
